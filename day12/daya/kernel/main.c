...
void bootmain(void)
{
	...
	init_pit();
	outb(PIC0_IMR, 0xf8); /* PITÆPIC1ÆL[{[hðÂ(11111000) */
	outb(PIC1_IMR, 0xef); /* }EXðÂ(11101111) */
	...
	sheet_setbuf(sht_back, buf_back, binfo->scrnx, binfo->scrny, -1); /* §ŸFÈµ */
	sheet_setbuf(sht_mouse, buf_mouse, 16, 16, 99);
	sheet_setbuf(sht_win, buf_win, 160, 52, -1); /* §ŸFÈµ */
